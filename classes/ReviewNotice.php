		...
		<div class="notice notice-info is-dismissible" id="<?php echo esc_attr( $this->plugin_slug ); ?>-review-notice" style="display: flex; align-items: center; padding: 12px;">
			...
			<p style="margin: 0.5em 0;">
				...
				printf(
					...
					esc_html__( 'Hey! You\'ve been using %1$s for a while now. If you\'re enjoying it, would you mind %2$sleaving a 5-star review%3$s? It helps us keep improving! 🙏', 'wooflare' ),
